        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-24 gap-8">
                ...
                <p className="text-xl text-[var(--muted-foreground)] max-w-xl">
                    ...
                    gains, and hit new personal records.
                </p>
                    ...
                    {[
                        {
                            ...
                            desc: "Log sets, reps, weight, RPE, and form rating per exercise.",
                        },
                        {
                            icon: TrendingUp,
                            title: "Body Metrics",
                            desc: "Track weight, body fat, waist, and other measurements over time.",
                        },
                        {
                            icon: BarChart3,
                            title: "Insights & Charts",
                            desc: "Visualize volume trends, strength progression, and muscle balance.",
                        },
                        {
                            icon: Shield,
                            title: "Personal Records",
                            desc: "Auto-detected PRs with estimated 1RM from every set you log.",
                        },
